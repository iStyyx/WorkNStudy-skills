...
Description: ajout de plusieurs éléments via un seul input dans un form

Plan d'action : (à valider par le formateur)

- action 1 revoir les codes précédants, le refaire et le comprendre (sous plusieurs jours) ❌
